# Driver AI - Static File Server (PowerShell)
param(
    [string]$RootPath = "C:\Users\vv925\.gemini\antigravity\scratch\driver-ai\admin-panel",
    [int]$Port = 8090
)
...
try {
    $listener.Start()
    Write-Host "🚀 Driver AI Admin Panel running at http://localhost:$Port/"
